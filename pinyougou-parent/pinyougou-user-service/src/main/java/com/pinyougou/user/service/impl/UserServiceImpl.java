...
public class UserServiceImpl implements UserService {
	...
	@Override
	public void createSms(final String phone) {
		//1.生成六位随机数
		...
		jmsTemplate.send("sms", new MessageCreator() {
			...
			public Message createMessage(Session session) throws JMSException {
				...
				mapMessage.setString("template_code",template_code);//阿里大于的消息模板
				mapMessage.setString("sign_name",sign_name);//阿里大于的签名
				Map map=new HashMap();
